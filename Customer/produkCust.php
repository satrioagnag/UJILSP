...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 class="text" style = "color: #008000">Semua Produk APOTEK WIN</h1>
</div><!-- End Page Title -->
                ...
                <div class="card" style="width: 22rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text d-flex justify-content-center">
                            ...
                            <?php endif; ?>
                            <a href="detailProduk.php?id=<?= $produk["idProduk"]; ?>" class="btn btn-primary" style="margin-left: 20px;">Detail</a>
                        </p>
                    </div>
