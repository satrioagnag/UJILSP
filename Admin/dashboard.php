...
<main id="main" class="main">
    ...
    <section class="section dashboard container">
      <div class="container">
            ...
            <div class="card info-card random-color succes-card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <h6 class="text-white"><?= $totalTransaksiSelesai; ?></h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3 text-white">
                            <h6 class="text-white"><?= $totalTransaksiBelumSelesai; ?></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card info-card random-color rejected-card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <h6 class="text-white"><?= $totalTransaksiReject; ?></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card info-card random-color cancelled-card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <h6 class="text-white"><?= $totalCancelTransaksi; ?></h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card info-card random-color productadm-card">
                <div class="card-body">
            ...
            <div class="card info-card random-color guestbook-card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <h6 class="text-white"><?= $totalGuestBook; ?></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card info-card random-color customer-card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <h6 class="text-white"><?= $totalCustomer; ?></h6>
                        </div>
                    </div>
                </div>
            </div>
